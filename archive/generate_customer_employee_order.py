...
# Growth rates
NEW_CUSTOMER_GROWTH_RATE = 0.18  # 15% new customers per year
REPEAT_CUSTOMER_RATE = 0.40      # 50% repeat customers per year
...
# print(customers_final_df)
customers_final_df["Date"] = pd.to_datetime(customers_final_df["Date"], errors="coerce")

cutoff = pd.Timestamp(date(BASELINE_YEAR - 1, 12, 31))  # e.g., 2021-12-31 if BASELINE_YEAR=2022
